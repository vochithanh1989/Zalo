 ...
 */
public class HeaderBarFavourit extends RelativeLayout implements View.OnClickListener {
    ...
    public String getTextView(){
        String a = mTxtHeaderTitle.getText().toString();
        return a;
    }
    public HeaderBarFavourit(Context context) {
        super(context);
        init(context);
    }

    public HeaderBarFavourit(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
        setAttributeSet(context, attrs);
    }

    public HeaderBarFavourit(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context) {
        mContext = context;
        mRootView = LayoutInflater.from(mContext).inflate(R.layout.header_bar_favourit, this, false);
        addView(mRootView);
        ...
        mImgSetting =(ImageView)mRootView.findViewById(R.id.setting);
