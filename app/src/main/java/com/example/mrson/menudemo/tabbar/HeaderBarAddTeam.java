 ...
 */
public class HeaderBarAddTeam extends RelativeLayout implements View.OnClickListener {
    ...
    public HeaderBarAddTeam(Context context) {
        super(context);
        init(context);
    }

    public HeaderBarAddTeam(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
        setAttributeSet(context, attrs);
    }

    public HeaderBarAddTeam(Context context, AttributeSet attrs, int defStyleAttr) {
